...
def visulization(img_file, mask_path, score_map_path, saving_path):
    ...
    # image
    img_name1 = '{}{}'.format(img_file, '.jpg')
    image_path = mask_path[:-7]
    image_file1 = os.path.join(image_path, 'image/', img_name1)
    # print(image_file1)
    img = cv2.imread(image_file1, cv2.IMREAD_COLOR)
    # print(img.size())
    ...
    # img_name1 = '{}{}'.format(img_file, '.jpg')
    # image_file1= os.path.join('/home/wyy/PycharmProjects/ss/gfdata/gf-2/test/image/', img_name1)
    # img = cv2.imread(image_file1, cv2.IMREAD_COLOR)
        # label = np.rot90(label)
    # img = cv2.resize(img, (360, 640))
    #     imsave("feature_maps/Results/gt_image/{}".format(img_name), image)
    ...
    # # mask
    # img_name2 = '{}{}'.format(img_file, '.png')
    img_name2 = '{}{}'.format(img_file, '.bmp')
    # mask_file = os.path.join(mask_path, img_name2)
    ...
    # binary score {0, 255}
    score_file = os.path.join(score_map_path, img_name2)
    # print(score_file)
    ...
    # save
    imsave(os.path.join(saving_path, "{}".format(img_name2)), img)
...
def visulization_score(img_file, mask_path, score_map_path, saving_path):
    ...
    # image
    img_name1 = '{}{}'.format(img_file.split('.png')[0], '.jpg')
    image_file1= os.path.join('/home/wyy/PycharmProjects/ABS2/absegdata/cross1/image/test/', img_name1)
    img = cv2.imread(image_file1, cv2.IMREAD_COLOR)
